...
var rsPR='<img src="http://server-au.imrworldwide.com/cgi-bin/count?url='+pUrl+'&rnd='+(new Date()).getTime()+'&cid='+pCid+'&ref='+refR+'&sr=sr'+rsSW+'x'+rsSH+':cd'+rsCD+':lg'+rsLG+':je'+rsJE+':ck'+rsCK+':tz'+rsTZ+':ct'+rsCT+':hp'+rsHP+'" width=1 height=1>';
...
rsPR='<applet code="Measure.class" codebase="http://server-au.imrworldwide.com/" width=1 height=2>'+pUrl+pCid+RSsr+'<param name="ref" value="'+refR+'"></applet>';}
