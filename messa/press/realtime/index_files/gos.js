...
if(go_apn=='Opera'){var i1=0,i2=0,sta;var v='N'}code='<a href="http://c2.gostats.com/gogi/viewstats.pl?mn='+go_mem+'" target="_top"><img src="http://c2.gostats.com/gogi/stats.pl?un='+go_mem+'&tz='+go_s+'&r='+escape(r)+'&s='+escape(s)+'&c='+escape(c)+'&o='+escape(o)+'&j='+j+'&v='+v+'&bw='+bw+'&bh='+bh+'&a='+escape(a)+'&gts='+go_ts+'" border="1"></a>'
